...
<main class="flex-1 pb-16 md:pb-0 bg-slate-100 min-h-screen">
    <div class="max-w-6xl mx-auto px-4 py-6 flex gap-4">
        ...
        <section class="flex-1 p-4 md:p-6 max-w-2xl">
            <h1 class="text-xl md:text-2xl font-semibold mb-2">Tambah Dosen</h1>
            <p class="text-sm text-slate-500 mb-4">
                Menambahkan dosen baru juga akan membuat akun login dengan password default
                <span class="font-mono text-xs bg-slate-100 px-1 py-0.5 rounded">dosen123</span>.
            </p>
